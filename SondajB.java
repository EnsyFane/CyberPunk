...
/**
 * Write a description of class SondajB here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class SondajB extends Raspunsuri
{
    private int x,y;
    ...
    public SondajB(int lungime , int inaltime)
    {
    ...
    public void CheckMouseOver()
    {
        ...
        if (mouse != null) {
            ...
            image.scale(x,y);
            setImage(image);   
            List objects = getWorld().getObjectsAt(mouse.getX(), mouse.getY(), SondajB.class);
