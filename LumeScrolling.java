...
public class LumeScrolling extends World
{
    ...
    private static int shouldAddB =400;
    ...
    {    
        ...
        setPaintOrder(Pauza.class,Raspunsuri.class,CPUS.class,Viata0.class,Viata1.class,Viata2.class,Tutoriale.class,Intrebare.class,Elev.class,Platforma.class,Cutie.class,PC.class,Laser.class,LaserOrizontal.class,CPU.class);
        ...
        viata1.setOk(okv1);
        viata2.setOk(okv2);
        LumeScrolling.setShouldAddB(400);
    ...
    public void act()
    {
        ...
        if(shouldAddB==400&&!afisatB)//Daca contorul pentru "boostere" ajunge la 400 si nu avem afisat pana acum obiectele le afisam
        {
            AddBoostere();
            afisatB=true;
        }
    ...
    public void scroll()
    {
        ...
        scroller.scroll(x,y);//Apelam functia de scroll a lumii in functie de pozitia acotrului principal
    ...
    public int getInf()//Functie pentru comprimarea salvarii
    {
        int slv;
        slv=(nvl*10);
        if(getViata0())
