...
public class LumeScrolling extends World
{
    ...
    {    
        ...
        setPaintOrder(Pauza.class,Raspunsuri.class,CPUS.class,Viata0.class,Viata1.class,Viata2.class,Tutoriale.class,Intrebari.class,Elev.class,Platforma.class,Cutie.class,PC.class);
    ...
    //Setam variabila pentru procesorul din nivel
