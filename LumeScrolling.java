...
public class LumeScrolling extends World
{
   ...
   Scroller scroller;
    ...
    {    
        ...
        setPaintOrder(Pauza.class,Raspunsuri.class,Viata0.class,Viata1.class,Viata2.class,Tutoriale.class,Intrebari.class,Elev.class,Platforma.class,Cutie.class,PC.class);
