        ...
        public class Elev extends Actor
{
    ...
    {
        if(Dreapta(Platforma.class,8)||Dreapta(Cutie.class,8))//Verificam daca in dreapta caracterului se afla o cutie sau o platforma
            return true;
        return false;
    }
    ...
    {
        if(Stanga(Platforma.class,8)||Stanga(Cutie.class,8))//Verificam daca in stanga caracterului se afla o cutie sau o platforma
            return true;
        return false;
    }
    ...
    public void BoostViteza()
    {
        ...
        {
            Sunete.Pickup();
            contorBoostV = 50;//Pornim contorul pentru efectul de viteza
    ...
    public void BoostSaritura()
    {
        ...
        {
            Sunete.Pickup();
            contorBoostS = 20;//Pornim contorul pentru efectul de saritura
