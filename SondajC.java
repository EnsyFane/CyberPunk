...
/**
 * Write a description of class SondajC here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class SondajC extends Raspunsuri
{
    private int x,y;
    ...
    public SondajC(int lungime , int inaltime)
    {
    ...
    public void CheckMouseOver()
    {
        ...
        if (mouse != null) {
            ...
            image.scale(x,y);
            setImage(image);   
            List objects = getWorld().getObjectsAt(mouse.getX(), mouse.getY(), SondajC.class);
