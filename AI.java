...
public class AI extends Actor
{
    ...
    public boolean VerifJos()
    {
        ...
        if(getY()>getWorld().getHeight()-67*s/3)//Verificam daca caracterul se afla pe sol 
            return true;
    ...
    public boolean BlocajDreapta()
    {
     //Verificam daca in dreapta caracterului se afla o cutie sau o platforma
        if(Dreapta(Platforma.class,5)||Dreapta(Cutie.class,5))
            return true;
        return false;
    }
    ...
    public boolean BlocajStanga()
    {
     //Verificam daca in stanga caracterului se afla o cutie sau o platforma
        if(Stanga(Platforma.class,5)||Stanga(Cutie.class,5))
            return true;
        return false;
    }
    ...
    public boolean Jos(Class aux)
    {
        ...
        if(getOneObjectAtOffset(latime /4 -2,inaltime /2 ,aux)!=null||getOneObjectAtOffset(latime /-4 +2,inaltime /2,aux)!=null)
            return true;
        return false;
    }
    ...
    public boolean Stanga(Class aux,int prox)
    {
        ...
        if(getOneObjectAtOffset(latime /-2 -prox*s/3 ,inaltime /-4 ,aux)!=null||getOneObjectAtOffset(latime /-2  -prox*s/3,inaltime /4 ,aux)!=null)
            return true;
        return false;
    }
